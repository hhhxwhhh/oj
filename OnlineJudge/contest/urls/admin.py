...
from ..views.admin import ContestAnnouncementAPI, ContestAPI, ACMContestHelper, DownloadContestSubmissions, ContestAnalyticsAPI
...
urlpatterns = [
    ...
    url(r"^contest/analytics/?$", ContestAnalyticsAPI.as_view(), name="contest_analytics_api"),
]