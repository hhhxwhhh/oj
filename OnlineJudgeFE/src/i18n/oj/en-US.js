export const m = {
  ...
  View_All: "View All",
  Hours: "Hours",
  Code_Diagnosis: "Code Diagnosis",
  Error_Analysis: "Error Analysis",
  Fix_Suggestions: "Fix Suggestions",
  Example_Code: "Example Code",
  Learning_Tips: "Learning Tips",
  Show_Diagnosis: "Show Diagnosis",
  Hide_Diagnosis: "Hide Diagnosis",
  Get_Code_Diagnosis: "Get Code Diagnosis",
  Code_is_already_accepted: "Code is already accepted",
  Failed_to_diagnose_code: "Failed to diagnose code",
  Submission_Unsuccessful: "Submission Unsuccessful",
  Back_to_Problem: "Back to Problem",
  View_Recommended_Problems: "View Recommended Problems",
  ...
  End_Time: "End Time",
  Is_Personalized: "Is Personalized",
  Problems: "Problems",
  Students: "Students",
  ...
  Cancel: "Cancel",
  Save: "Save",
  Add_Selected_Problems: "Add Selected Problems",
  Search_Problem_By_ID_or_Title: "Search problem by ID or title",
  Selected_Problems: "Selected Problems",
  No_Problems_Selected: "No problems selected",
  Please_enter_a_search_keyword: "Please enter a search keyword",
  Please_select_at_least_one_problem: "Please select at least one problem",
  Please_add_at_least_one_problem: "Please add at least one problem",
  Please_set_start_and_end_time: "Please set start and end time",
  ...
  Are_you_sure_you_want_to_delete_this_assignment:
  ...
  Personalized_Problems: "Personalized Problems",
  Generate_Personalized_Assignment: "Generate Personalized Assignment",
  Based_on_Learning_Path: "Based on Learning Path",
  Based_on_Knowledge_Points: "Based on Knowledge Points",
  Based_on_Historical_Performance: "Based on Historical Performance",
  Assignment_Effectiveness: "Assignment Effectiveness",
  Improvement_in_Problem_Solving: "Improvement in Problem Solving",
  Before_Assignment: "Before Assignment",
  After_Assignment: "After Assignment",
  Knowledge_Point_Mastery: "Knowledge Point Mastery",
  Student_Performance_Analysis: "Student Performance Analysis",
  ...
  Loading: "Loading...",
  Failed_to_get_Assignments: "Failed to get assignments",
  Start_Time: "Start Time",
  End_Time: "End Time",
