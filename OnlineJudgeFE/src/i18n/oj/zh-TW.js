export const m = {
  ...
  Where_is_the_input_and_the_output_answer_part_9:
    "來輸出到stdout。你的程式不被允許讀取或著是寫入檔案，否則你將獲得",
  What_is_the_meaning_of_submission_execution_time: "提交執行時間是什麼意思?",
  What_is_the_meaning_of_submission_execution_time_answer:
    "線上解題系統可能會使用不同的輸入檔案來多次測試你的程式碼。如果你的程式碼在每個輸入檔案的時間限制內給出正確的答案，則顯示的執行時間是每個測資所花費的最大時間。否則，執行時間將毫無意義",
