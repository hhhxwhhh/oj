  ...
  <div class="view">
    <Panel title="Contest List">
      ...
      <el-table v-loading="loading" element-loading-text="loading" ref="table" :data="contestList" style="width: 100%">
        ...
        <el-table-column fixed="right" width="300" label="Operation">
          <div slot-scope="scope">
            ...
            <icon-btn name="Analytics" icon="line-chart" @click.native="goContestAnalytics(scope.row.id)"></icon-btn>
