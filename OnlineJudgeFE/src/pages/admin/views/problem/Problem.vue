    ...
    <Panel :title="title">
      <el-form ref="form" :model="problem" :rules="rules" label-position="top" label-width="70px">
        ...
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item prop="description" :label="$t('m.Description')" required>
              <MarkdownEditor v-model="problem.description"></MarkdownEditor>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item prop="input_description" :label="$t('m.Input_Description')" required>
              <MarkdownEditor v-model="problem.input_description"></MarkdownEditor>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item prop="output_description" :label="$t('m.Output_Description')" required>
              <MarkdownEditor v-model="problem.output_description"></MarkdownEditor>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
        ...
        <div class="add-sample-btn">
          <button type="button" class="add-samples" @click="addSample()"><i class="el-icon-plus"></i>{{
            $t('m.Add_Sample') }}
          </button>
        </div>
        <el-form-item style="margin-top: 20px" :label="$t('m.Hint')">
          <MarkdownEditor v-model="problem.hint" placeholder=""></MarkdownEditor>
        </el-form-item>
